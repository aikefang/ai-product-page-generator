...
export const CLIENT_PROVIDER_STORAGE_KEY = "turing:provider-credentials:v1";
  ...
  useEffect(() => {
    ...
    window.fetch = (input, init = {}) => {
      ...
      if (credentials.apiKey) {
        headers.set("x-turing-api-key", credentials.apiKey);
      }
      if (credentials.baseUrl) {
        headers.set("x-turing-base-url", credentials.baseUrl);
      }
